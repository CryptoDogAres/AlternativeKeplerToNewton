...
With the notation of \Cref{fig:inverse-problem}, the hodograph of $\mathbf v$ is a circle of radius $u$ (hence the $\Delta t$-scaled hodograph circle has radius $u\Delta t$). If the fixed shift satisfies $OR'=c\,\Delta t\cos\alpha$, then
\begin{equation}
