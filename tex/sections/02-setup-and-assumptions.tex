...
\textbf{Hypothesis H2 (area law):} \emph{equal areas are swept in equal times} about $F$ (Kepler's second law, 1609). Equivalently, there is a constant $k$ such that for any time interval of length $t$, the swept area satisfies
\begin{equation}
  S = k\,t.
\end{equation}
