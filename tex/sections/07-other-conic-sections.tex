...
This extreme limit corresponds to rectilinear (radial) motion, which may be viewed as a degenerate conic with zero areal speed about the force center.
In this paper we treat it only as a boundary case and do not analyze it further.
Newton does discuss this case in the \emph{Principia}, but it is outside our present scope.
