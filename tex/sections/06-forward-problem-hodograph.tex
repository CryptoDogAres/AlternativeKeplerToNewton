...
\end{proof}
This concludes the first forward-problem proof, which is a direct infinitesimal version of the hodograph construction. The second proof will be a discrete version of the same logic, more focusing on the Auxiliary circle geometry.
